    ...
    <div className="p-4 bg-card rounded-lg border border-border/50 space-y-3">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-sm">
        <div>
          ...
          <p className="font-medium text-foreground">{contrato.tipo_vinculo}</p>
        </div>
        <div>
          <p className="text-muted-foreground text-xs">Serviço</p>
          <p className="font-medium text-foreground">{contrato.servico_prestado}</p>
        </div>
        <div>
          ...
          return (
            ...
            >
              ...
              <AccordionContent className="px-0 pb-0">
                <div className="bg-accent/30 p-4 space-y-6">
                  {/* Dados do Cliente */}
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    ...
                    {cliente.cidade && (
                      <div className="flex items-center gap-2 text-sm">
                        ...
                        <span className="text-foreground">{cliente.cidade}{cliente.uf && ` - ${cliente.uf}`}</span>
                      </div>
                    )}
                    {cliente.cnpj && (
                      <div className="text-sm">
                        <span className="text-muted-foreground">CNPJ: </span>
                        <span className="text-foreground">{cliente.cnpj}</span>
                      </div>
                    )}
                  </div>
                  ...
                  {cliente.rotina_visitas && (
                    <div className="p-3 bg-card rounded-lg border border-border/50">
                      <h4 className="text-sm font-medium text-foreground mb-2">Rotina de Visitas</h4>
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 text-sm">
                        <div>
                          <p className="text-muted-foreground text-xs">Frequência</p>
                          <p className="font-medium text-foreground">{cliente.frequencia_visita || "-"}</p>
                        </div>
                        <div>
                    ...
                    <TabsContent value="contratos" className="mt-4">
                      <div>
                        <div className="flex items-center justify-between mb-3">
                          <h4 className="text-sm font-medium text-foreground">Contratos</h4>
