  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        <p className="font-medium text-zinc-900 truncate">{alerta.nome}</p>
    ...
    <Popover>
      ...
      <PopoverContent className="w-96 p-0 bg-white" align="end">
        <div className="p-4 border-b border-slate-200">
          <h3 className="font-semibold text-zinc-900">Visitas Agendadas</h3>
            ...
            <div className="p-2 space-y-4">
              ...
              {atrasadasList.length > 0 && (
                <div className="space-y-1">
                  <p className="px-2 text-xs font-medium text-red-600 uppercase tracking-wide">
              ...
              {hojeList.length > 0 && (
                <div className="space-y-1">
                  <p className="px-2 text-xs font-medium text-orange-600 uppercase tracking-wide">
              ...
              {proximosList.length > 0 && (
                <div className="space-y-1">
                  <p className="px-2 text-xs font-medium text-slate-600 uppercase tracking-wide">
