...
export function WidgetEvolucaoLeads({ enabled }: WidgetEvolucaoLeadsProps) {
  ...
  return (
    <Card className="relative bg-gradient-to-br from-slate-50 to-zinc-100 dark:from-zinc-900 dark:to-slate-900 border-slate-200 dark:border-zinc-800 col-span-1 lg:col-span-2 transition-all duration-200 hover:shadow-lg hover:border-primary/30 hover:z-10">
